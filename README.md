...
A focused plugin pack for Claude Code and Codex. It contains five engineering workflows that help turn an idea into a clear specification and plan, then improve the resulting code through review and simplification.
...
Invoke `idea-refine` directly by naming the skill in your request.
...
See [docs/codex-setup.md](docs/codex-setup.md) for the manifest layout and usage notes.

## Repository layout

```text
skills/                    Five shared Claude Code and Codex skills
...
hooks/                     Optional simplify-ignore helper for Claude Code
```
